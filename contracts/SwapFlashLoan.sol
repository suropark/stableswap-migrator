...
contract SwapFlashLoan is Swap {
    ...
    function flashLoan(
        ...
        require(availableLiquidityAfter >= availableLiquidityBefore + amountFee, "flashLoan fee is not met");
        swapStorage.balances[tokenIndex] = availableLiquidityAfter - protocolBalanceBefore - protocolFee;
